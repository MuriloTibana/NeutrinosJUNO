...
# ============================================================
# Figure 2-style plot: contours + spectra
# ============================================================
...
if RUN_SOLAR_SCAN:
    ...
    def plot_contours_and_profiles(
        ...
        """Plot 2D contours plus the two 1D profiled Delta-chi-square curves."""
    ...
    ax_spec2 = fig.add_subplot(right[1, 0], sharex=ax_spec1)
    ...
    ax_spec2.set_xlabel(r"$E_{\rm pr}$ [MeV]")
