...
FIG_PATH = "img/osc_sys_norm_bg_lihe_flux.png"
...
def compute_reactor_prompt_spectrum(xi_flux):
    """
    Compute the reactor prompt spectrum for a given set
    of Daya Bay flux pulls.
    ...
    energy_centers, prompt_spectrum = (
        compute_spectrum_with_response(
            E_nu,
            integrand,
            Epr_edges,
            "nonlinear",
...
# ============================================================
# Nominal and flux-pulled reactor spectra
# ============================================================
...
# compute_spectrum_with_response returns a unit-normalized curve.
C_norm = (
    juno_peak
    / model_peak
)
...
print(
    "Flux-pulled reactor events before rate pull: "
    f"{np.sum(osc_spectra_flux_pulled):.3f}"
)
